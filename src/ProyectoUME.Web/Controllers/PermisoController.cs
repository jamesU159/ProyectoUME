...
namespace ProyectoUME.Web.Controllers
{
    public class PermisoController : Controller
    {
        ...
        public PermisoController(ProyectoUMEDbContext context)
        {
            _context = context;
        }
        ...
        {
            var proyectoUMEDbContext = _context.Permiso.Include(p => p.RolIdRolNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPermiso,Nombre1,Nombre2,Apellido1,Apellido2,Correo,Telefono,RolIdRol")] Permiso permiso)
        {
