...
namespace ProyectoUME.Web.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public ProyectoesController(ProyectoUMEDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CodigoProyecto,NumeroEmpleados,DireccionProyecto,PersonaResponsable")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodigoProyecto,NumeroEmpleados,DireccionProyecto,PersonaResponsable")] Proyecto proyecto)
        {
        ...
        {
            return _context.Proyecto.Any(e => e.CodigoProyecto == id);
        }
    }
}
